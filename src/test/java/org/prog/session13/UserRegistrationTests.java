...
public class UserRegistrationTests {
    ...
    public void Phonne(String color){
        ...
        Assertions.assertEquals(phone.getColor(), "Black");
        System.out.println("This phone realy black"+phoneColors());
    }
public static Stream<Arguments> phoneColors(){
        return Stream.of(Arguments.of(("Black")));
